...
TEST_CASE("Creating column_iterators") 
{
    SECTION("Default Constructor")
    {
        cortex::column_iterator<typename std::vector<int>::iterator> it;
    ...
    SECTION("Value Constructor")
    {
        ...
        auto it { cortex::column_iterator<typename std::vector<int>::iterator>(v.begin(), 0ul, 0ul, 5ul, 2ul) };
