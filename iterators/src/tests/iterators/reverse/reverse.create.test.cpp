...
TEST_CASE("Creating reverse_iterators") 
{
    SECTION("Test 1 : std::vector::iterator -> reverse_iterator")
    {
        ...
        auto it = cortex::reverse_iterator<std::vector<int>::iterator>(v.end());
        REQUIRE(*it == 5);
        ++it;
        REQUIRE(*it == 4);
        ++it;
    ...
    {
        std::vector<int> v = {1, 2, 3, 4, 5};
        auto it = cortex::make_reverse<std::vector<int>>(v.end());
        REQUIRE(*it == 5);
        ++it;
        REQUIRE(*it == 4);
        ++it;
    ...
    {
        std::vector<int> v = {1, 2, 3, 4, 5};
        auto it = cortex::make_reverse<decltype(v)>(v.end());
        REQUIRE(*it == 5);
        ++it;
        REQUIRE(*it == 4);
        ++it;
    ...
    {
        int arr[] = {1, 2, 3, 4, 5};
        auto it = cortex::make_reverse<int*>(arr + 5);
        REQUIRE(*it == 5);
        ++it;
        REQUIRE(*it == 4);
        ++it;
